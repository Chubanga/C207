...
public class ManipuladorConsultas {
    ...
    private final PacienteHasMedicoDAO pacienteDao = new PacienteHasMedicoDAO();
    public ManipuladorConsultas() {
        listaConsultas = consultaDao.buscarConsulta();
      
    }

    public void cadastra(Consulta consulta,PacienteHasMedico paciente) throws ErroCadastroException {
        ...
        pacienteDao.inserirPacienteHasMedico(paciente); 
    }
